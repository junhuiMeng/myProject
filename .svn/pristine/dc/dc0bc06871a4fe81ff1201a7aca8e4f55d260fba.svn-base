 ...
 */
package com.nodesoft.modules.act.web;
...
import com.nodesoft.modules.act.service.ActTaskService;
...
//		return "modules/act/actTaskForm";
	 ...
	 * 		vars.keys=flag,pass
	 * 		vars.values=1,true
	 * 		vars.types=S,B  @see com.nodesoft.modules.act.utils.PropertyType
	 */
