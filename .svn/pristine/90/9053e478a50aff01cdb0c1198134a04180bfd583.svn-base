...
public class SendSms {
    ...
    public boolean SingleSender(String receiver, String randomNum) throws  Exception {
         //必填,请参考"开发准备"获取如下数据,替换为实际值
        String url = "https://rtcsms.cn-north-1.myhuaweicloud.com:10743/sms/batchSendSms/v1"; //APP接入地址+接口访问URI
        String appKey = "ILNxBm067Vx7W4x0RxKqK206iw5T"; //APP_Key
        String appSecret = "HZJ06KCZ0OL296Ibzm4vfELJW96a"; //APP_Secret
        String sender = "10690400999303089"; //国内短信签名通道号或国际/港澳台短信通道号
        String templateId = "922eb1a749584f2e8b03b80ed7864ee7"; //模板ID
         ...
         */
        String templateParas = "["+randomNum+"]"; //模板变量
